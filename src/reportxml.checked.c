...
/* Prototypes */
static int __attach_copy_of_node_or_definition(reportxml_node_t *parent, reportxml_node_t *node : itype(_Ptr<reportxml_node_t> ) , _Ptr<reportxml_database_t> db, ssize_t depth);
...
static reportxml_node_t * __reportxml_node_copy_with_db(reportxml_node_t *node : itype(_Ptr<reportxml_node_t> ) , _Ptr<reportxml_database_t> db, ssize_t depth)
{
    reportxml_node_t *ret;
    ssize_t child_count;
...
reportxml_node_t * reportxml_node_copy(reportxml_node_t *node : itype(_Ptr<reportxml_node_t> ) )
{
    return __reportxml_node_copy_with_db(node, NULL, -1);
}

xmlNodePtr reportxml_node_render_xmlnode(reportxml_node_t *node : itype(_Ptr<reportxml_node_t> ) )
{
    xmlNodePtr ret;
    ssize_t child_count;
    ssize_t xml_child_count;
...
int reportxml_database_add_report(reportxml_database_t *db : itype(_Ptr<reportxml_database_t> ) , reportxml_t *report : itype(_Ptr<reportxml_t> ) )
{
    reportxml_node_t *root;
    ssize_t count;
    size_t i;
