...
static void free_ogg_codecs(ogg_state_t *ogg_info : itype(_Ptr<ogg_state_t> ) )
{
    ogg_codec_t *codec;
 ...
 */
static _Ptr<refbuf_t> process_ogg_page(ogg_state_t *ogg_info : itype(_Ptr<ogg_state_t> ) , ogg_page *page, _Ptr<format_plugin_t> plugin)
{
