...
refobject_t refobject_new__real(const refobject_type_t *type, void* userdata, _Nt_array_ptr<const char> name, refobject_t associated);
...
refobject_t refobject_new__simple(const refobject_type_t *type, void* userdata, _Nt_array_ptr<const char> name, refobject_t associated, ...);
...
_Ptr<const char> refobject_get_name(refobject_t self);
