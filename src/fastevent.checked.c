...
struct eventrow {
    size_t length;
    size_t used;
    _Array_ptr<_Ptr<fastevent_registration_t>> registrations;
};
...
static int __add_to_row(_Ptr<struct eventrow> row, fastevent_registration_t *registration : itype(_Ptr<fastevent_registration_t> ) )
{
    _Array_ptr<_Ptr<fastevent_registration_t>> n = NULL;
