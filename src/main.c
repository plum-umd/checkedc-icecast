...
static int _parse_config_opts(int argc, _Array_ptr<_Nt_array_ptr<char>> argv, _Array_ptr<char> filename, size_t size)
{
    int i = 1;
    int config_ok = 0;
...
static inline void __log_system_name(void) {
    ...
    _Nt_array_ptr<char> system =  "(unknown)";
    int have_hostname = 0;
#ifdef HAVE_UNAME
...
#else
int main(int argc, _Nt_array_ptr<_Nt_array_ptr<char>> argv)
#endif
{
    int res, ret;
