...
static void _parse_audio_info(source_t *source : itype(_Ptr<source_t> ) , const char *s : itype(_Nt_array_ptr<const char> ) );
...
#endif
            {
                _Ptr<client_t> client =  source->client;
